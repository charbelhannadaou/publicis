...
def optimization_by_total_response_tool():
    ...
    st.markdown("Goal: Achieve the specified Total Response by ensuring non-zero media spend.")
...
def optimization_by_media_response_tool():
    ...
    st.markdown("Goal: Achieve the specified Media Response by ensuring non-zero media spend.")
...
def main():
    ...
    page = st.sidebar.radio("Go to", ["Optimization by Budget", "Optimization by Minimum Budget", "Optimization by Total Response", "Optimization by Media Response"])

    if page == "Optimization by Budget":
