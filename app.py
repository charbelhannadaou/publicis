...
# Main function for Optimization Tool
    ...
    if uploaded_file:
        ...
        if st.button("Optimize"):
            ...
            if optimization_goal == "Total Budget":
                ...
                spends_df = optimize_response(spends_df, channels, alphas, gammas, thetas, betas, num_weeks, total_response_target, media_contribution_target)
...
def main():
    ...
    page = st.sidebar.radio("Go to", ["Media Response Forecasting Tool", "Optimization Tool"])
